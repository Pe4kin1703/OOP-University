...
public interface ILabCalculatorListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterModDivExpr([NotNull] LabCalculatorParser.ModDivExprContext context);
	/// <summary>
	/// Exit a parse tree produced by the <c>ModDivExpr</c>
	/// labeled alternative in <see cref="LabCalculatorParser.expression"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitModDivExpr([NotNull] LabCalculatorParser.ModDivExprContext context);

	/// <summary>
	/// Enter a parse tree produced by the <c>UnarExpr</c>
	/// labeled alternative in <see cref="LabCalculatorParser.expression"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterUnarExpr([NotNull] LabCalculatorParser.UnarExprContext context);
	/// <summary>
	/// Exit a parse tree produced by the <c>UnarExpr</c>
	/// labeled alternative in <see cref="LabCalculatorParser.expression"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitUnarExpr([NotNull] LabCalculatorParser.UnarExprContext context);

	/// <summary>
	/// Enter a parse tree produced by the <c>BigExpr</c>
	/// labeled alternative in <see cref="LabCalculatorParser.expression"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterBigExpr([NotNull] LabCalculatorParser.BigExprContext context);
	/// <summary>
	/// Exit a parse tree produced by the <c>BigExpr</c>
	/// labeled alternative in <see cref="LabCalculatorParser.expression"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
